    ...
    <>
      ...
      <div className="bg-gray-100 dark:bg-black">
        <div className="mx-auto max-w-7xl p-4 sm:p-6 lg:p-8">
          <div
            className={
              " w-full my-8 mt-4 font-semibold text-2xl md:text-3xl lg:text-4xl xl:text-4xl text-center"
            }
          >
            Choose a blog to update & delete
          </div>
          <hr className="my-8" />
          <div className="mx-auto max-w-2xl lg:max-w-none">
            <div className="mt-6 space-y-12 lg:grid lg:grid-cols-3 lg:gap-6 lg:space-y-0">
              {callouts.map((callout, index) => (
                ...
                >
                  <Link href={`/admin/updateBlog/${callout[0]}`}>
                    <div className="w-16 h-8 bg-blue-400 hover:bg-blue-600 absolute -right-2 -top-4 flex justify-center items-center text-white font-semibold z-20 rounded-lg">
                      Edit
                    </div>
                  </Link>
